...
export default function KeeperLogin({ onLogin }) {
    ...
    const handleLogin = async () => {
        try {
            ...
            const response = await fetch(`${BASE_URL}/loginKeeper`, {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                localStorage.setItem('keeperId',userId);
                ...
                navigate('/petKeeper-dash');

                // onLogin(); // Trigger a callback to notify the parent component
            } else {
    ...
    return (
        <div className="max-w-md mx-auto mt-16 p-6 bg-white shadow-md rounded-lg">
            <h2 className="text-2xl font-semibold mb-4">Keeper Login</h2>
            <div className="mb-4">
